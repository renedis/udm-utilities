# Contributing to unifi-common

First time contributing to unifi-common? Read our [Code of Conduct](https://github.com/unifi-utilities/unifi-common/blob/main/.github/CODE_OF_CONDUCT.md#code-of-conduct)

### Discuss, ask questions about or disagree with changes in unifi-common

- [unifi-utilities/discussions](https://github.com/orgs/unifi-utilities/discussions) is the place for community discussions around unifi-common.
- Our issues and pull requests are for maintainers and contributors to discuss work to be done, not users or contributors asking questions about unifi-common usage or disagreeing with changes already made.
